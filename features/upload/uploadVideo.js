...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function loadCategories() {
    try {
      const response = await fetch('https://cb-back-prueba-c2e1a4ci8-sebitasdowns-projects.vercel.app/categories');
      if (!response.ok) {
  ...
  async function loadSpeakers() {
    try {
      const response = await fetch('https://cb-back-prueba-c2e1a4ci8-sebitasdowns-projects.vercel.app/speakers');
      if (!response.ok) {
  ...
  uploadVideoForm.addEventListener('submit', async function (event) {
    ...
    try {
      ...
      const response = await fetch('https://cb-back-prueba-c2e1a4ci8-sebitasdowns-projects.vercel.app/videos/create', {
        method: 'POST',
        body: formData,
